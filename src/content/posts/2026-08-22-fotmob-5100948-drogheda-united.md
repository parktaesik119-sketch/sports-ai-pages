---
title: "드로에다 유나이티드 vs St. Patrick's Athletic 경기분석·라인업·결장자·통계·승부예측 (8월 22일) | D1 - 픽천국"
date: 2026-08-21T18:45:00.000Z
description: "드로에다 유나이티드 vs St. Patrick's Athletic 경기분석 및 승부예측 입니다. 팀 전력, 선발라인업, 최근 성적, 상대전적(H2H),부상.결장자정보, 경기 통계, 최신 스포츠분석 및 추천 스포츠픽을 픽천국에서 확인하세요."
slug: "analyze-fotmob-5100948-2026-08-22-drogheda-united"
category: "soccer"
country: "아일랜드"
league: "D1"
homeTeam: "드로에다 유나이티드"
...
homeAnalysis: "드로에다 유나이티드는 2026시즌 최근 17경기에서 6승 6무 5패, 평균 득점 1.5를 기록하며 안정적인 득점 흐름을 보여주고 있습니다. 최근에는 원정에서 골을 만들어내는 장면이 살아났고, 홈에서는 쉽게 무너지지 않는 운영이 이어지고 있어 전반적인 전력의 균형이 나쁘지 않습니다. 다만 득점이 폭발적으로 터지기보다는 경기별 편차가 있는 편이라, 상대 압박이 강한 팀을 만나면 마무리 효율이 관건이 됩니다. 홈에서 실점을 크게 늘리지 않는 장점도 확인되고 있어, 수비 집중력이 유지되면 접전 양상으로 끌고 갈 가능성이 있습니다. 특히 에단 오브라이언과 오언 램브의 결장은 측면과 활동량 운영에 부담을 줄 수 있어, 전체적인 전개 속도와 뒷문 안정성에 영향을 줄 수 있습니다."
awayAnalysis: "세인트 패트릭스 애슬레틱은 2026시즌 최근 3경기에서 2승 1무 0패, 평균 득점 1.7로 상승세를 이어가고 있습니다. 최근 흐름을 보면 경기 내 주도권을 오래 가져가며 필요한 순간에 득점을 만들어내는 장면이 돋보입니다. 실점 관리도 비교적 안정적이라, 경기 후반까지 집중력을 유지하는 운영이 강점으로 평가됩니다. 원정에서도 경기력의 하락폭이 크지 않아, 초반만 버티면 후반에 더 유리한 흐름을 만들 수 있습니다. 결장자가 없는 점도 전력 유지 측면에서 긍정적으로 보이며, 현재 흐름을 그대로 이어갈 기반은 충분합니다."
homePower: "최근 맞대결 열세로 심리 부담이 큼|득점은 나오지만 폭발력은 기복이 있음|홈에서 버티는 운영이 실점 억제에 도움됨|주요 결장으로 측면 전개 효율 저하 우려|접전에서는 수비 집중력이 승부 변수로 보임"
...
injuryHome: "Ethan O'Brien[주요](근육 부상 - 복귀예정 Unknown) | Owen Lambe[주요](다리 부상 - 복귀예정 Unknown)"
injuryAway: "없음"
homeLineup: ''
awayLineup: ''
homeFormation: ""
