...
"CR Khemis Zemamra": "RCA 제맘라",
  ...
  // ===== 🇯🇵 J2, J3리그 (J2, J3 League) =====
  "Iwaki FC": "이와키 FC",
  "Albirex Niigata": "알비렉스 니가타",
  "Tochigi City FC": "도치기 시티 FC",
  ...
  "Fagiano Okayama FC": "파지아노 오카야마 FC",
  "Kashima Antlers": "가시마 앤틀러스",
  "Yokohama F.Marinos": "요코하마 F.마리노스",
  "Sanfrecce Hiroshima Regina": "산프레체 히로시마 레지나",
  "Omiya Ardija Ventus": "오미야 아르디자 벤투스",
  ...
  "Jeonbuk Hyundai Motors FC Reserves": "전북 현대",
...
// ===== 🇰🇷 한국 FA컵 시민구단/아마추어팀 추가분 =====
 ...
 "Jungkwanjang Red Sparks": "정관장",
  ...
  // 유로리그
  "Fenerbahce": "페네르바흐체",
  "Zalgiris Kaunas": "FK 카우노 잘기리스",
  "FK Kauno Zalgiris": "FK 카우노 잘기리스",
  "FK Kauno Žalgiris": "FK 카우노 잘기리스",
  "Olimpiacos": "올림피아코스",
  ...
  "Bolivar": "볼리바르",
  "Bolívar": "볼리바르",
  "Coquimbo Unido": "코키보 유니도",
  "Club Atletico Platense": "CA 플라테넨세",
  "Club Atlético Platense": "CA 플라테넨세",
  "Cusco": "쿠스코 FC",
  "Palmeiras": "팔메이라스",
