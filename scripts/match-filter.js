...
if (isExtraFiltered) {
  ...
  const isFirstDivision = ['DIVISION 1', '1 DIVISION', 'PREMIER DIVISION', 'PREMIERSHIP', 'SUPER LEAGUE', 'PRO LEAGUE', 'PREMIER', 'A LEAGUE', 'JUPILER PRO LEAGUE', 'AFRICAN CLUB CHAMPIONSHIP', 'PFL', 'AFC U17 ASIAN CUP', 'J1 LEAGUE', 'J2/J3 LEAGUE', 'PRIMERA DIVISIÓN - APERTURA', "AFC WOMEN'S CHAMPIONS LEAGUE",'LEAGUE ONE', 'V.LEAGUE 1', 'TAIWAN FOOTBALL PREMIER LEAGUE','DFB POKAL', 'COPA LIBERTADORES','COPA LIBERTADORES 32TH FINALS','COPA LIBERTADORES 16TH FINALS','COPA LIBERTADORES 8TH FINALS','COPA LIBERTADORES 4TH FINALS','COPA LIBERTADORES SEMI FINALS','COPA LIBERTADORES FINAL','WK-LEAGUE','PRIMERA A','WORLD CUP - WOMEN - QUALIFICATION EUROPE','ASEAN CHAMPIONSHIP', 'LIGA I','EUROPA LEAGUE QUALIFICATION','EUROPA LEAGUE','CONFERENCE LEAGUE QUALIFICATION','CONFERENCE LEAGUE','SAUDI PRO LEAGUE'].some(el => el === upperLg);
