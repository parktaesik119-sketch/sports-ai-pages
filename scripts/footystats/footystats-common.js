...
// deriveFormationFromLineup()으로 이 코드들을 세어 유추한다. ESPN도 하위 리그에서
// 같은 문제(라인업은 주는데 formation 필드가 비어있음)를 겪어서, 이 로직을
// scripts/formation-common.js로 공용화해 양쪽이 같이 쓴다(2026-07).
export { deriveFormationFromLineup };
