...
import { parseFrontmatterField, toShortDate, sendTelegramMessageWithBlocks, sendTelegramPhoto, SPORT_LABEL_KO, buildPostUrl, escapeHtml } from './telegram-common.js';
...
async function main() {
  ...
  await sendTelegramMessageWithBlocks(HEADER, dateBlocks);
